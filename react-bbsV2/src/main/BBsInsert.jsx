      ...
      const { b_writer, b_subject, b_content } = state;
        return (
          <div className="input_form">
            <input name="b_writer"  value={b_writer}  onChange={handleOnChange} placeholder="작성자"/>
            <input name="b_subject" value={b_subject} onChange={handleOnChange} placeholder="제목"/>
            <input name="b_content" value={b_content} onChange={handleOnChange} placeholder="내용"/>
